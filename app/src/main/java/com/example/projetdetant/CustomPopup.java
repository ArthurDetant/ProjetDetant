...
public class CustomPopup extends Dialog {
    ...
    public CustomPopup(Activity activity){ //Récupération du layout de la popup(my_popup_template)
    ...
    public String getVie(){
        return editTextvie.getText().toString();
    }

    public String getPuissance(){
        return editTextpuissance.getText().toString();
    }

    public String getPuissanceMaxMonstre(){
        return editTextmaxmonstre.getText().toString();
    }
    ...
    public void build(){  // Affiche la popup
        show();
    }
}
